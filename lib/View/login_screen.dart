                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: const Text("Sing Up",style: TextStyle(color: Colors.teal)),
            ...
            children: [
              ...
              InkWell(
                onTap: () {
                  ...
                  {
                    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Wrong id & pass....")));
                  }
                },
                child: Container(
                  height: 50,
                  width: double.infinity,
                  alignment: Alignment.center,
                  child: const Text("Login",style: TextStyle(color: Colors.teal,fontSize: 25)),
                  decoration: BoxDecoration(color: Colors.teal.shade100,borderRadius: BorderRadius.circular(10),border: Border.all(color: Colors.teal)),
                ),
              )
            ],
